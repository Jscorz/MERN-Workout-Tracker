...
function WorkoutModal({
	...
	// 					<h1 className='pt-2'>1. {exerciseOne.name}</h1>
	...
	// 					<h1 className='pt-2'>2. {exerciseTwo.name}</h1>
	// 					<div className='flex justify-between w-full h-1/2 py-2 px-8 md:px-20'>
	// 						<div>
	// 							<p>reps</p>
	// 							<p>{repsTwo}</p>
	...
	// 				</div>
	// 				<div className='w-full h-36 flex flex-col items-center bg-white text-slate-900 shadow-lg border border-slate-500/50 mb-3 rounded-lg'>
	// 					<h1 className='pt-2'>3. {exerciseThree.name}</h1>
	// 					<div className='flex justify-between w-full h-1/2 py-2 px-8 md:px-20'>
	// 						<div>
	// 							<p>reps</p>
	// 							<p>{repsThree}</p>
	...
	// 				</div>
	// 				<div className='w-full h-36 flex flex-col items-center bg-white text-slate-900 shadow-lg border border-slate-500/50 mb-3 rounded-lg'>
	// 					<h1 className='pt-2'>4. {exerciseFour.name}</h1>
	// 					<div className='flex justify-between w-full h-1/2 py-2 px-8 md:px-20'>
	// 						<div>
	// 							<p>reps</p>
	// 							<p>{repsFour}</p>
	...
	// 				</div>
	// 				<div className='w-full h-36 flex flex-col items-center bg-white text-slate-900 shadow-lg border border-slate-500/50 mb-3 rounded-lg'>
	// 					<h1 className='pt-2'>5. {exerciseFive.name}</h1>
	// 					<div className='flex justify-between w-full h-1/2 py-2 px-8 md:px-20'>
	// 						<div>
	// 							<p>reps</p>
	// 							<p>{repsFive}</p>
	...
	// 				</div>
	// 				<div className='w-full h-36 flex flex-col items-center bg-white text-slate-900 shadow-lg border border-slate-500/50 mb-3 rounded-lg'>
	// 					<h1 className='pt-2'>6. {exerciseSix.name}</h1>
	// 					<div className='flex justify-between w-full h-1/2 py-2 px-8 md:px-20'>
	// 						<div>
	// 							<p>reps</p>
	// 							<p>{repsSix}</p>
